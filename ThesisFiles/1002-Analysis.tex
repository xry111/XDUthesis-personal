...
$\ell_1$ 最小化重建仿真中使用的小波基来自 \verb|ltfat| 软件包，其滤波器组为
...
在本章中，我们首先完成了基于压缩感知的太阳能电池缺陷检测系统的理论设计，
说明了采用互阻型放大器和二值矩阵，保证测量结果线性的必要性。之后我们设计
了测试用例，并通过数值仿真，验证了小波域下的 $\ell_1$ 最小化算法和空间域中
全变分最小化算法
的恢复效果。结果表明，全变分最小化算法更适合处理边界清晰、形状规则的缺陷，
而 $\ell_1$ 最小化算法的适用范围更广，可以较好地恢复出梯度并不稀疏的缺陷。
然而，无论是哪一种算法，对于太阳能电池的主电极和栅电极都无能为力。可见，
消除电极对压缩感知方法造成的不利影响，对于进一步提高压缩感知缺陷检测方法的
效率和准确度具有重要意义。
